 ...
 */
public class FunGoodsAdapter  extends BaseAdapter{
    ...
    public FunGoodsAdapter(Context context, ArrayList<GoodsBean> mList,String m_id) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.list_fungoods,null);
            ...
            //holder.beizhu_text = (TextView)convertView.findViewById(R.id.good_beizhu);
            holder.webView = (WebView)convertView.findViewById(R.id.good_beizhu);
        ...
        holder.webView.loadDataWithBaseURL(null,mList.get(position).getRemark(),"text/html", "utf-8",null);
            //holder.webView.loadData(URLEncoder.encode(mList.get(position).getRemark(), "utf-8"), "text/html", "utf-8");
        ...
        //holder.beizhu_text.setText("说明："+mList.get(position).getRemark());
    ...
    private class ViewHolder {
        ...
        public TextView tv_name,beizhu_text;
        public TextView price;
        public TextView s_price;
        public ImageView good_collect_img;
