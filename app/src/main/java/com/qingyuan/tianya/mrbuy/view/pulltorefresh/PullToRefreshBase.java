package com.qingyuan.tianya.mrbuy.view.pulltorefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		String pullToRefreshLabel = context.getString(R.string.pull_to_refresh_pull_label);//下拉刷新
		String refreshingLabel = context.getString(R.string.pull_to_refresh_refreshing_label);//正在刷新
		String releaseToRefreshLabel = context.getString(R.string.pull_to_refresh_release_label);//松开刷新
		String pullToLoadLabel = context.getString(R.string.pull_to_loadmore_pull_label);//上拉加载更多
		String loadingLabel = context.getString(R.string.pull_to_loadmore_loading_label);//正在加载
		String releaseToLoadLabel = context.getString(R.string.pull_to_loadmore_release_label);//松开加载
...
//					refreshingLabel);
		...
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			footerLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH);//, pullToLoadLabel, loadingLabel);
